...
func newConfig() (*config, error) {
	...
	flag.StringVar(&cfg.sentryAddress, "sentry-address", fmt.Sprintf("dapr-sentry.%s.svc:443", security.CurrentNamespace()), "Filepath to the trust anchors for the Dapr control plane")
