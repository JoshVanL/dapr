...
func New(origArgs []string) (*Options, error) {
	...
	fs.StringSliceVar(&opts.SchedulerAddresses, "scheduler-host-addresses", nil, "Addresses of the Scheduler service instance(s), as comma separated host:port pairs")
