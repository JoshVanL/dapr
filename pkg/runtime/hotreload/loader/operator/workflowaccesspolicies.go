...
//
//nolint:unused
func (w *workflowAccessPolicies) list(ctx context.Context, opclient operatorpb.OperatorClient, ns, podName string) ([][]byte, error) {
...
//nolint:unused
func (w *workflowAccessPolicies) establish(ctx context.Context, opclient operatorpb.OperatorClient, ns, podName string) error {
