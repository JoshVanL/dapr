...
func (o *orchestrator) loadInternalState(ctx context.Context) (*wfenginestate.State, *protos.WorkflowMetadata, error) {
...
func (o *orchestrator) ometaFromState(rstate *protos.WorkflowRuntimeState, startEvent *protos.ExecutionStartedEvent) *protos.WorkflowMetadata {
