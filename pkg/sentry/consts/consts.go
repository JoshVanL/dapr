...
const (
	...
	// SentryTrustDomainEnvVar is the environment variable name holding the trust
	// domain in which the sentry belongs to.
	SentryTrustDomainEnvVar = "DAPR_SENTRY_TRUST_DOMAIN"
)
