...
type Options struct {
	KubeClient     clkube.Interface
	DaprClient     cldapr.Interface
...
func New(opts Options) validator.Interface {
	return &kubernetes{
		auth:           opts.KubeClient.AuthenticationV1(),
		pod:            opts.KubeClient.CoreV1(),
		config:         opts.DaprClient.ConfigurationV1alpha1(),
