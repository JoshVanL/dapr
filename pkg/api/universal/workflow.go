...
func (u *Universal) GetWorkflowAlpha1(ctx context.Context, in *runtimev1pb.GetWorkflowRequest) (*runtimev1pb.GetWorkflowResponse, error) {
	if err := u.validateInstanceID(in.InstanceId, false /* isCreate */); err != nil {
		u.logger.Debug(err)
		return &runtimev1pb.GetWorkflowResponse{}, err
	}

	workflowComponent, err := u.getWorkflowComponent(in.WorkflowComponent)
	if err != nil {
		u.logger.Debug(err)
		return &runtimev1pb.GetWorkflowResponse{}, err
	}
...
func (u *Universal) StartWorkflowAlpha1(ctx context.Context, in *runtimev1pb.StartWorkflowRequest) (*runtimev1pb.StartWorkflowResponse, error) {
	if err := u.validateInstanceID(in.InstanceId, true /* isCreate */); err != nil {
		u.logger.Debug(err)
...
func (u *Universal) TerminateWorkflowAlpha1(ctx context.Context, in *runtimev1pb.TerminateWorkflowRequest) (*emptypb.Empty, error) {
...
func (u *Universal) RaiseEventWorkflowAlpha1(ctx context.Context, in *runtimev1pb.RaiseEventWorkflowRequest) (*emptypb.Empty, error) {
	emptyResponse := &emptypb.Empty{}
	if err := u.validateInstanceID(in.InstanceId, false /* isCreate */); err != nil {
		u.logger.Debug(err)
		return emptyResponse, err
...
func (u *Universal) PauseWorkflowAlpha1(ctx context.Context, in *runtimev1pb.PauseWorkflowRequest) (*emptypb.Empty, error) {
	emptyResponse := &emptypb.Empty{}
	if err := u.validateInstanceID(in.InstanceId, false /* isCreate */); err != nil {
		u.logger.Debug(err)
		return emptyResponse, err
...
func (u *Universal) ResumeWorkflowAlpha1(ctx context.Context, in *runtimev1pb.ResumeWorkflowRequest) (*emptypb.Empty, error) {
	emptyResponse := &emptypb.Empty{}
	if err := u.validateInstanceID(in.InstanceId, false /* isCreate */); err != nil {
		u.logger.Debug(err)
		return emptyResponse, err
...
func (u *Universal) PurgeWorkflowAlpha1(ctx context.Context, in *runtimev1pb.PurgeWorkflowRequest) (*emptypb.Empty, error) {
	emptyResponse := &emptypb.Empty{}
	if err := u.validateInstanceID(in.InstanceId, false /* isCreate */); err != nil {
		u.logger.Debug(err)
		return emptyResponse, err
...
func (u *Universal) validateInstanceID(instanceID string, isCreate bool) error {
	if instanceID == "" {
...
func (u *Universal) getWorkflowComponent(componentName string) (workflows.Workflow, error) {
	if componentName == "" {
		return nil, messages.ErrNoOrMissingWorkflowComponent
	}

	workflowComponent, ok := u.compStore.GetWorkflow(componentName)
	if !ok {
