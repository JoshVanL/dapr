...
type ComponentReportRequest_Type int32

const (
	// Not specified - use the default value.
	ComponentReportRequest_UNKNOWN ComponentReportRequest_Type = 0
	// INIT indicates reporting the component initialization.
	ComponentReportRequest_INIT ComponentReportRequest_Type = 1
)

// Enum value maps for ComponentReportRequest_Type.
var (
	ComponentReportRequest_Type_name = map[int32]string{
		0: "UNKNOWN",
		1: "INIT",
	}
	ComponentReportRequest_Type_value = map[string]int32{
		"UNKNOWN": 0,
		"INIT":    1,
	}
)

func (x ComponentReportRequest_Type) Enum() *ComponentReportRequest_Type {
	p := new(ComponentReportRequest_Type)
	*p = x
	return p
}

func (x ComponentReportRequest_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ComponentReportRequest_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_dapr_proto_operator_v1_operator_proto_enumTypes[1].Descriptor()
}

func (ComponentReportRequest_Type) Type() protoreflect.EnumType {
	return &file_dapr_proto_operator_v1_operator_proto_enumTypes[1]
}

func (x ComponentReportRequest_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ComponentReportRequest_Type.Descriptor instead.
func (ComponentReportRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_dapr_proto_operator_v1_operator_proto_rawDescGZIP(), []int{18, 0}
}
...
type ComponentReportRequest struct {
	...
	Type               ComponentReportRequest_Type `protobuf:"varint,1,opt,name=type,proto3,enum=dapr.proto.operator.v1.ComponentReportRequest_Type" json:"type,omitempty"`
	Status             v1.ConditionStatus          `protobuf:"varint,2,opt,name=status,proto3,enum=dapr.proto.common.v1.ConditionStatus" json:"status,omitempty"`
...
func (x *ComponentReportRequest) Reset() {
	*x = ComponentReportRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ComponentReportRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ComponentReportRequest) ProtoMessage() {}

func (x *ComponentReportRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dapr_proto_operator_v1_operator_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ComponentReportRequest.ProtoReflect.Descriptor instead.
func (*ComponentReportRequest) Descriptor() ([]byte, []int) {
	return file_dapr_proto_operator_v1_operator_proto_rawDescGZIP(), []int{18}
}

func (x *ComponentReportRequest) GetType() ComponentReportRequest_Type {
	if x != nil {
		return x.Type
	}
	return ComponentReportRequest_UNKNOWN
}

func (x *ComponentReportRequest) GetStatus() v1.ConditionStatus {
	if x != nil {
		return x.Status
	}
...
func (x *ComponentReportRequest) GetComponentName() string {
	if x != nil {
...
func (x *ComponentReportRequest) GetReason() string {
...
func (x *ComponentReportRequest) GetMessage() string {
...
func (x *ComponentReportRequest) GetObservedGeneration() int64 {
	if x != nil {
...
var file_dapr_proto_operator_v1_operator_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x22, 0x73, 0x0a, 0x14, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x55,
	...
	0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x12, 0x3d, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x37, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x43,
	...
	0x70, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x22, 0xea, 0x02, 0x0a, 0x16, 0x43,
	0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x3d,
	...
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x04,
	...
	0x6e, 0x22, 0x1d, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x47, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x32, 0x86, 0x09, 0x0a, 0x08, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x73, 0x0a,
	...
	0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x5d, 0x0a, 0x0f, 0x43, 0x6f,
	0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x2e, 0x2e,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74,
...
var file_dapr_proto_operator_v1_operator_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dapr_proto_operator_v1_operator_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_dapr_proto_operator_v1_operator_proto_goTypes = []interface{}{
	...
	(ComponentReportRequest_Type)(0),  // 1: dapr.proto.operator.v1.ComponentReportRequest.Type
	...
	(*GetHTTPEndpointRequest)(nil),    // 14: dapr.proto.operator.v1.GetHTTPEndpointRequest
	(*GetHTTPEndpointResponse)(nil),   // 15: dapr.proto.operator.v1.GetHTTPEndpointResponse
	(*ListHTTPEndpointsResponse)(nil), // 16: dapr.proto.operator.v1.ListHTTPEndpointsResponse
	(*ListHTTPEndpointsRequest)(nil),  // 17: dapr.proto.operator.v1.ListHTTPEndpointsRequest
	(*HTTPEndpointUpdateRequest)(nil), // 18: dapr.proto.operator.v1.HTTPEndpointUpdateRequest
	(*HTTPEndpointUpdateEvent)(nil),   // 19: dapr.proto.operator.v1.HTTPEndpointUpdateEvent
	(*ComponentReportRequest)(nil),    // 20: dapr.proto.operator.v1.ComponentReportRequest
	(v1.ConditionStatus)(0),           // 21: dapr.proto.common.v1.ConditionStatus
...
var file_dapr_proto_operator_v1_operator_proto_depIdxs = []int32{
	...
	1,  // 1: dapr.proto.operator.v1.ComponentReportRequest.type:type_name -> dapr.proto.operator.v1.ComponentReportRequest.Type
	21, // 2: dapr.proto.operator.v1.ComponentReportRequest.status:type_name -> dapr.proto.common.v1.ConditionStatus
	3,  // 3: dapr.proto.operator.v1.Operator.ComponentUpdate:input_type -> dapr.proto.operator.v1.ComponentUpdateRequest
	2,  // 4: dapr.proto.operator.v1.Operator.ListComponents:input_type -> dapr.proto.operator.v1.ListComponentsRequest
	6,  // 5: dapr.proto.operator.v1.Operator.GetConfiguration:input_type -> dapr.proto.operator.v1.GetConfigurationRequest
	22, // 6: dapr.proto.operator.v1.Operator.ListSubscriptions:input_type -> google.protobuf.Empty
	9,  // 7: dapr.proto.operator.v1.Operator.GetResiliency:input_type -> dapr.proto.operator.v1.GetResiliencyRequest
	11, // 8: dapr.proto.operator.v1.Operator.ListResiliency:input_type -> dapr.proto.operator.v1.ListResiliencyRequest
	13, // 9: dapr.proto.operator.v1.Operator.ListSubscriptionsV2:input_type -> dapr.proto.operator.v1.ListSubscriptionsRequest
	17, // 10: dapr.proto.operator.v1.Operator.ListHTTPEndpoints:input_type -> dapr.proto.operator.v1.ListHTTPEndpointsRequest
	18, // 11: dapr.proto.operator.v1.Operator.HTTPEndpointUpdate:input_type -> dapr.proto.operator.v1.HTTPEndpointUpdateRequest
	20, // 12: dapr.proto.operator.v1.Operator.ComponentReport:input_type -> dapr.proto.operator.v1.ComponentReportRequest
	4,  // 13: dapr.proto.operator.v1.Operator.ComponentUpdate:output_type -> dapr.proto.operator.v1.ComponentUpdateEvent
	5,  // 14: dapr.proto.operator.v1.Operator.ListComponents:output_type -> dapr.proto.operator.v1.ListComponentResponse
	7,  // 15: dapr.proto.operator.v1.Operator.GetConfiguration:output_type -> dapr.proto.operator.v1.GetConfigurationResponse
	8,  // 16: dapr.proto.operator.v1.Operator.ListSubscriptions:output_type -> dapr.proto.operator.v1.ListSubscriptionsResponse
	10, // 17: dapr.proto.operator.v1.Operator.GetResiliency:output_type -> dapr.proto.operator.v1.GetResiliencyResponse
	12, // 18: dapr.proto.operator.v1.Operator.ListResiliency:output_type -> dapr.proto.operator.v1.ListResiliencyResponse
	8,  // 19: dapr.proto.operator.v1.Operator.ListSubscriptionsV2:output_type -> dapr.proto.operator.v1.ListSubscriptionsResponse
	16, // 20: dapr.proto.operator.v1.Operator.ListHTTPEndpoints:output_type -> dapr.proto.operator.v1.ListHTTPEndpointsResponse
	19, // 21: dapr.proto.operator.v1.Operator.HTTPEndpointUpdate:output_type -> dapr.proto.operator.v1.HTTPEndpointUpdateEvent
	22, // 22: dapr.proto.operator.v1.Operator.ComponentReport:output_type -> google.protobuf.Empty
...
func file_dapr_proto_operator_v1_operator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dapr_proto_operator_v1_operator_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ComponentReportRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_dapr_proto_operator_v1_operator_proto_msgTypes[18].OneofWrappers = []interface{}{}
	type x struct{}
