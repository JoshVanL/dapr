...
const (
	...
	Dapr_BulkSubscribeTopicEventsAlpha1_FullMethodName = "/dapr.proto.runtime.v1.Dapr/BulkSubscribeTopicEventsAlpha1"
...
type DaprClient interface {
	...
	BulkSubscribeTopicEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (Dapr_BulkSubscribeTopicEventsAlpha1Client, error)
...
func (c *daprClient) BulkSubscribeTopicEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (Dapr_BulkSubscribeTopicEventsAlpha1Client, error) {
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[1], Dapr_BulkSubscribeTopicEventsAlpha1_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &daprBulkSubscribeTopicEventsAlpha1Client{stream}
	return x, nil
}

type Dapr_BulkSubscribeTopicEventsAlpha1Client interface {
	Send(*BulkSubscribeTopicEventsRequestAlpha1) error
	Recv() (*BulkSubscribeTopicEventsResponseAlpha1, error)
	grpc.ClientStream
}

type daprBulkSubscribeTopicEventsAlpha1Client struct {
	grpc.ClientStream
}

func (x *daprBulkSubscribeTopicEventsAlpha1Client) Send(m *BulkSubscribeTopicEventsRequestAlpha1) error {
	return x.ClientStream.SendMsg(m)
}

func (x *daprBulkSubscribeTopicEventsAlpha1Client) Recv() (*BulkSubscribeTopicEventsResponseAlpha1, error) {
	m := new(BulkSubscribeTopicEventsResponseAlpha1)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type DaprServer interface {
	...
	BulkSubscribeTopicEventsAlpha1(Dapr_BulkSubscribeTopicEventsAlpha1Server) error
	// Invokes binding data to specific output bindings
...
func (UnimplementedDaprServer) BulkSubscribeTopicEventsAlpha1(Dapr_BulkSubscribeTopicEventsAlpha1Server) error {
	return status.Errorf(codes.Unimplemented, "method BulkSubscribeTopicEventsAlpha1 not implemented")
}
...
func _Dapr_BulkSubscribeTopicEventsAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).BulkSubscribeTopicEventsAlpha1(&daprBulkSubscribeTopicEventsAlpha1Server{stream})
}

type Dapr_BulkSubscribeTopicEventsAlpha1Server interface {
	Send(*BulkSubscribeTopicEventsResponseAlpha1) error
	Recv() (*BulkSubscribeTopicEventsRequestAlpha1, error)
	grpc.ServerStream
}

type daprBulkSubscribeTopicEventsAlpha1Server struct {
	grpc.ServerStream
}

func (x *daprBulkSubscribeTopicEventsAlpha1Server) Send(m *BulkSubscribeTopicEventsResponseAlpha1) error {
	return x.ServerStream.SendMsg(m)
}

func (x *daprBulkSubscribeTopicEventsAlpha1Server) Recv() (*BulkSubscribeTopicEventsRequestAlpha1, error) {
	m := new(BulkSubscribeTopicEventsRequestAlpha1)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var Dapr_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BulkSubscribeTopicEventsAlpha1",
			Handler:       _Dapr_BulkSubscribeTopicEventsAlpha1_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
