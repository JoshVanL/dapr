...
func GetOperatorClient(ctx context.Context, address string, sec security.Interface) (operatorv1pb.OperatorClient, *grpc.ClientConn, error) {
	...
	operatorID, err := spiffeid.FromSegments(
		sec.ControlPlaneTrustDomain(),
		"ns", sec.ControlPlaneNamespace(), "dapr-operator",
	)
	if err != nil {
		return nil, nil, err
	}
