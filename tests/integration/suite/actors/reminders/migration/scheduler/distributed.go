...
spec:
  ...
  - name: SchedulerReminders
    enabled: true
`))
	optsWithApp2 := append(optsWithScheduler, daprd.WithAppPort(d.app2.Port()))

	daprd1 := daprd.New(t, append(opts, daprd.WithAppPort(d.app1.Port()))...)
	daprd2 := daprd.New(t, optsWithApp2...)
	daprd3 := daprd.New(t, optsWithApp2...)
	daprd4 := daprd.New(t, optsWithApp2...)
	daprd5 := daprd.New(t, optsWithApp2...)
	daprd6 := daprd.New(t, append(optsWithScheduler, daprd.WithAppPort(d.app1.Port()))...)
