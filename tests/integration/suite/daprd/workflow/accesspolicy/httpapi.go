...
func (h *httpapi) Run(t *testing.T, ctx context.Context) {
	...
	require.NoError(t, registry.AddOrchestratorN("AllowedWF", func(ctx *task.OrchestrationContext) (any, error) {
		return "allowed-ok", nil
	}))

	require.NoError(t, registry.AddOrchestratorN("DeniedWF", func(ctx *task.OrchestrationContext) (any, error) {
