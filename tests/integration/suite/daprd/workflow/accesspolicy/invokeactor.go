...
func (ia *invokeactor) Run(t *testing.T, ctx context.Context) {
	...
	require.NoError(t, targetRegistry.AddOrchestratorN("SecretWF", func(ctx *task.OrchestrationContext) (any, error) {
	...
	require.NoError(t, attackerRegistry.AddOrchestratorN("DummyWF", func(ctx *task.OrchestrationContext) (any, error) {
		return "dummy", nil
	}))
