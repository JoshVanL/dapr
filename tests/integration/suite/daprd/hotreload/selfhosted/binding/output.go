...
import (
	...
	"github.com/dapr/dapr/tests/integration/suite/daprd/hotreload/meta"
)
...
func (o *output) Run(t *testing.T, ctx context.Context) {
	...
	t.Run("expect no components to be loaded yet", func(t *testing.T) {
		assert.Len(t, meta.GetComponents(t, ctx, client, o.daprd.HTTPPort()), 0)
	})
...
`, o.bindingDir1)), 0o600))
		require.EventuallyWithT(t, func(c *assert.CollectT) {
			assert.Len(c, meta.GetComponents(t, ctx, client, o.daprd.HTTPPort()), 1)
...
`, o.bindingDir1, o.bindingDir2)), 0o600))
		require.EventuallyWithT(t, func(c *assert.CollectT) {
			assert.Len(c, meta.GetComponents(t, ctx, client, o.daprd.HTTPPort()), 2)
		}, time.Second*5, time.Millisecond*100)
...
`, o.bindingDir3)), 0o600))
		require.EventuallyWithT(t, func(c *assert.CollectT) {
			assert.Len(c, meta.GetComponents(t, ctx, client, o.daprd.HTTPPort()), 3)
		}, time.Second*5, time.Millisecond*100)
...
`, o.bindingDir2)), 0o600))
	...
	t.Run("deleting component files are no longer available", func(t *testing.T) {
		...
		require.EventuallyWithT(t, func(c *assert.CollectT) {
			assert.Len(c, meta.GetComponents(t, ctx, client, o.daprd.HTTPPort()), 0)
		}, time.Second*5, time.Millisecond*100)
		o.postBindingFail(t, ctx, client, "binding1")
		o.postBindingFail(t, ctx, client, "binding2")
		o.postBindingFail(t, ctx, client, "binding3")
...
func (o *output) assertFile(t *testing.T, dir, file, expData string) {
	...
	require.NoError(t, err)
	assert.Equal(t, expData, string(fdata))
}
